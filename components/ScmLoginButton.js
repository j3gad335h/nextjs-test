...
export default function ScmLoginButton() {
  ...
  return (
    <a href={LoginUrl} target="_blank" className={classes.loginButton} size="medium">
      <SvgIcon style={{ left: locale === "ar" ? "10px" : "0px" }} className={classes.svgicon}>
        <path id="Arrwo" d="M373.914,49l2.1-1.906L372.611,44l3.4-3.091L373.914,39l-4.451,4.043a1.264,1.264,0,0,0,0,1.907Z" transform="translate(-369.03 -39.004)" fill="#1e396c" />
      </SvgIcon>
      {t("menu.ScmLogin")}
    </a>
  );
