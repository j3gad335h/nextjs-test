        ...
        <Grid container spacing={2}>
              ...
              backContent={
                <div>
                  <Typography className={classes.backContent} variant="h5" component="div">
                    {t("home.finace service discription1")}
                  </Typography>{" "}
                </div>
              }
            />
          ...
          <Grid className={classes.GridRow} item xs={12} sm={6} md={4} lg={4} xl={4}>
            <FlipBox
              ...
              frontContent={
                <div>
                  <Typography variant="h5" className={classes.frontContent} component="div">
                    {t("home.finace service2")}
                  </Typography>
                </div>
              }
              backContent={
                <div>
                  <Typography variant="h5" className={classes.backContent} component="div">
                    {t("home.finace service discription2")}
                  </Typography>
                </div>
              }
            />
          ...
          <Grid className={classes.GridRow} item xs={12} sm={6} md={4} lg={4} xl={4}>
            <FlipBox
              ...
              backContent={
                <div>
                  <Typography variant="h5" className={classes.backContent} component="div">
                    {t("home.finace service discription3")}
                  </Typography>
                </div>
              }>
              {/* Lazy load backgroundImage */}
              <Image src={image3} alt="" layout="fill" objectFit="cover" loading="lazy" />
            </FlipBox>
          </Grid>
          ...
          <Grid className={classes.GridRow} item xs={12} sm={6} md={4} lg={4} xl={4}>
            <FlipBox
              ...
              backContent={
                <div>
                  <Typography variant="h5" className={classes.backContent} component="div">
                    {t("home.finace service discription4")}
                  </Typography>
                </div>
              }
            />
          ...
          <Grid className={classes.GridRow} item xs={12} sm={6} md={4} lg={4} xl={4}>
            <FlipBox
              ...
              backContent={
                <div>
                  <Typography variant="h5" className={classes.backContent} component="div">
                    {t("home.finace service discription5")}
                  </Typography>
                </div>
              }
            />
          ...
          <Grid className={classes.GridRow} item xs={12} sm={6} md={4} lg={4} xl={4}>
            <FlipBox
              ...
              backContent={
                <div>
                  <Typography variant="h5" className={classes.backContent} component="div">
                    {t("home.finace service discription6")}
                  </Typography>
                </div>
              }
            />
