...
export default function PosFinanceService() {
    ...
    return (
        <Container maxWidth="xl" className={classes.container}>
            <Grid style={{marignLeft:'10px !importnat'}}  columns={{ xs: 4, sm: 8, md: 12 }} container>
                <Grid className={classes.serviceGrid} item xs={12} sm={12} md={2.2} lg={2.2} xl={2.2}>
                    <Box className={classes.serviceBox}>
                        <Image width={25} height={25} alt="service1" src={image1} className={classes.serviceImage} />
                    </Box>
                    <Typography className={classes.ServiceText}  >{t('posFinance.service1')}</Typography>
                </Grid>
                <div className={classes.ServiceDivider} />
                <Grid className={classes.serviceGrid} item xs={12} sm={12} md={2.6} lg={2.6} xl={2.6}>
                    <Box className={classes.serviceBox}>
                        <Image width={25} height={25}  alt="service2" src={image2} className={classes.serviceImage} />
                    </Box>
                    <Typography className={classes.ServiceText}  >{t('posFinance.service2')}</Typography>
                </Grid>
                <div className={classes.ServiceDivider} />
                <Grid className={classes.serviceGrid} item xs={12} sm={12} md={2.6} lg={2.6} xl={2.6}>
                    <Box className={classes.serviceBox}>
                    ...
                    <Typography className={classes.ServiceText}  >{t('posFinance.service3')}</Typography>
                </Grid>
                <div className={classes.ServiceDivider} />
                <Grid className={classes.serviceGrid} item xs={12} sm={12} md={2.2} lg={2.2} xl={2.2}>
                    <Box className={classes.serviceBox}>
                    ...
                    <Typography className={classes.ServiceText}  >{t('posFinance.service4')}</Typography>
                </Grid>
                <div className={classes.ServiceDivider} />
                <Grid className={classes.serviceGrid} item xs={12} sm={12} md={2.4} lg={2.4} xl={2.4}>
                    ...
                    <Typography className={classes.ServiceText}  >{t('posFinance.service5')}</Typography>
                </Grid>
            </Grid>
        </Container>
    )
