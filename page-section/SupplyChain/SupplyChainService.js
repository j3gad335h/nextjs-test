    ...
    return (
        <Container maxWidth="xl" className={classes.container}>
            <Grid spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }} container >
                <Grid className={classes.serviceGrid} item xs={12} sm={12} md={4} lg={4} xl={4}>
                    <Box className={classes.serviceBox}>
                        <Image width={25} height={25} alt="service1" src={image1} className={classes.serviceImage} />
                    </Box>
                    <Typography className={classes.ServiceText}  >{t("supply chain.supply service1")}</Typography>
                </Grid>
                ...
                <Grid className={classes.serviceGrid} item xs={12} sm={12} md={4} lg={4} xl={4}>
                    ...
                    <Typography className={classes.ServiceText}  >{t("supply chain.supply service2")}</Typography>
                </Grid> 
                <div className={classes.ServiceDivider} />
                <Grid className={classes.serviceGrid} item xs={12} sm={12} md={4} lg={4} xl={4}>
                    <Box className={classes.serviceBox}>
                    ...
                    <Typography className={classes.ServiceText}  >{t("supply chain.supply service3")}</Typography>
                </Grid>
