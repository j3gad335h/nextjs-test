...
export default function FinanceService() {
    ...
    const image1 = "/assetsNew/images/ServiceIcons/money.webp";
    const image2 = "/assetsNew/images/ServiceIcons/robot.webp";
    const image3 = "/assetsNew/images/ServiceIcons/charity.webp";
    ...
    return (
        <Container maxWidth="xl" className={classes.container}>
            <Grid spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }} container >
                <Grid className={classes.serviceGrid} item xs={12} sm={12} md={2.5} lg={3} xl={3}>
                    <Box className={classes.serviceBox}>
                        <Image width={25} height={25} alt="service1" src={image1} className={classes.serviceImage} />
                    </Box>
                    <Typography className={classes.ServiceText}  >{t("finance.service1")}</Typography>
                </Grid>
                <div className={classes.ServiceDivider} />
                <Grid className={classes.serviceGrid} item xs={12} sm={12} md={3.5} lg={3} xl={3}>
                    <Box className={classes.serviceBox}>
                        <Image width={25} height={25} alt="service2" src={image2} className={classes.serviceImage} />
                    </Box>
                    <Typography className={classes.ServiceText}  >{t("finance.service2")}</Typography>
                </Grid>
                <div className={classes.ServiceDivider} />
                <Grid className={classes.serviceGrid} item xs={12} sm={12} md={3.5} lg={3} xl={3}>
                    <Box className={classes.serviceBox}>
                    ...
                    <Typography className={classes.ServiceText}  >{t("finance.service3")}</Typography>
                </Grid>
                <div className={classes.ServiceDivider} />
                <Grid className={classes.serviceGrid} item xs={12} sm={12} md={2.5} lg={3} xl={3}>
                    <Box className={classes.serviceBox}>
                    ...
                    <Typography className={classes.ServiceText}  >{t("finance.service4")}</Typography>
                </Grid>
