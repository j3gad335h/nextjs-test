    ...
    return (
        <section>
            <Container className={classes.Container}>
                <Box>
                    <Typography variant='h1' className={classes.hometittle}>{t("financerTerm.Financers Terms conditions tittle")}</Typography>
                    <Typography className={classes.Introduction}>{t("financerTerm.Financers Terms conditions sub tittle1")}</Typography>
                </Box>
                <Typography className={classes.Introduction}>{t("financerTerm.Financers Terms conditions sub tittle2")} </Typography>
                <Typography className={classes.discription}>{t("financerTerm.Financers Terms conditions discription1")}</Typography>
                <Typography className={classes.discription}>{t("financerTerm.Financers Terms conditions discription2")}</Typography>
                <Divider className={classes.Divider} />
                <Typography className={classes.Introduction}> {t("financerTerm.Financers Terms conditions sub tittle3")}</Typography>
                <Typography className={classes.discription}>
                    {t("financerTerm.Financers Terms conditions discription4")}
                    <strong>&nbsp;{t("financerTerm.Financers Terms conditions discription4 1")}</strong> &nbsp;{t("financerTerm.Financers Terms conditions discription4 2")}
                    <strong>&nbsp;{t("financerTerm.Financers Terms conditions discription4 3")}</strong>&nbsp;{t("financerTerm.Financers Terms conditions discription4 4")}
                    <strong>&nbsp;{t("financerTerm.Financers Terms conditions discription4 5")}</strong>&nbsp;{t("financerTerm.Financers Terms conditions discription4 6")}
                </Typography>
                <Typography className={classes.discription}>{t("financerTerm.Financers Terms conditions discription5")}
                    <strong>&nbsp;{t("financerTerm.Financers Terms conditions discription5 1")}</strong>&nbsp;{t("financerTerm.Financers Terms conditions discription5 2")}</Typography>
                <Typography className={classes.discription}>{t("financerTerm.Financers Terms conditions discription6")}</Typography>
                <Divider className={classes.Divider} />
                <Typography className={classes.Introduction}>{t("financerTerm.Financers Terms conditions sub tittle4")}</Typography>
                <ul className={classes.listItem}>
                    <ul  className={classes.listItem} >
                        <Typography className={classes.discription}>{t("financerTerm.Financers Terms conditions discription7")}</Typography>
                        <ul >
                            <Typography className={classes.discription}>{t("financerTerm.Financers Terms conditions discription8")}</Typography>
                            <ul  className={classes.listItem} >
                                <li><Typography className={classes.discription}><strong>{t("financerTerm.Financers Terms conditions discription9")}</strong>
                                        &nbsp;{t("financerTerm.Financers Terms conditions discription9 1")}</Typography></li>
                                <li><Typography className={classes.discription}>
                                        <strong>{t("financerTerm.Financers Terms conditions discription10")}</strong>
                                        &nbsp;{t("financerTerm.Financers Terms conditions discription10 1")}
                                    </Typography>
                                </li>
                                <li><Typography className={classes.discription}>
                                        <strong>{t("financerTerm.Financers Terms conditions discription11")}</strong>
                                        &nbsp;{t("financerTerm.Financers Terms conditions discription11 1")}
                                    </Typography></li>
                                <li><Typography className={classes.discription}>
                                        <strong>{t("financerTerm.Financers Terms conditions discription12")}</strong>
                                        &nbsp;{t("financerTerm.Financers Terms conditions discription12 1")}
                                    </Typography></li>
                                <li><Typography className={classes.discription}>
                                        <strong>{t("financerTerm.Financers Terms conditions discription13")}</strong>
