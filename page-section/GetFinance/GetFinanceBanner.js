...
const Image1 = "/assetsNew/images/GetFinance/Landing-Page-Banner-Slide_2.svg";
...
export default function GetFinanceBanner() {
        ...
        <HeroBanner className={classes.heroBanner} backgroundImage={Image1}>
            ...
            <Container className={classes.container}>
                <Typography color="inherit" variant="h1" className={classes.bannerText}>
                    {t('getFinance.bannerText')}
                </Typography>
                <Button onClick={handleClickOpen} size="large" className={classes.Button}>{t('getFinance.BannerButton')}</Button>
            </Container>
            {/* modal */}
            <Dialog
                open={open}
